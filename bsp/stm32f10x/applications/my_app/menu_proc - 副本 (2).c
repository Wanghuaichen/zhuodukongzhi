...
static void screen_ch1_set(uint8_t* pscreen_index,uint8_t msg)
{
    ...
    static uint8_t stat = 0,timer,set_stat,flag,curr_select;
    ...
    if(flag == 0)
    {
		...
		label[0].x = 0; label[0].y = 0; label[0].is_focused = 0;label[0].label_stat = 0;label[0].width = 13;
		snprintf(label[0].label_buf,label[0].width,"%s","CH1目标");
		label[1].x = 0; label[1].y = 16; label[1].is_focused = 0;label[1].label_stat = 0;label[1].width = 13;
		snprintf(label[1].label_buf,label[1].width,"%s","波动范围");
		label[2].x = 0; label[2].y = 32; label[2].is_focused = 0;label[2].label_stat = 0;label[2].width = 13;
		snprintf(label[2].label_buf,label[2].width,"%s","参比系数");
		label[3].x = 0; label[3].y = 48; label[3].is_focused = 0;label[3].label_stat = 0;label[3].width = 13;
        ...
        number_box[0].x = 7*8; number_box[0].y = 0 ; number_box[0].is_focused = 0; number_box[0].box_stat = 0; number_box[0].box_width = 5; number_box[0].data_width = 5; 
        number_box[0].set_index = 0; number_box[0].data_type = INTEGER; number_box[0].min = 0; number_box[0].max = 30001;
        snprintf(number_box[0].set_buf,number_box[0].box_width,"%-d",global.zhuodu_data.canbi_set);
        
        number_box[1].x = 8*8; number_box[1].y = 16 ; number_box[1].is_focused = 0; number_box[1].box_stat = 0; number_box[1].box_width = 5; number_box[1].data_width = 5; 
        number_box[1].set_index = 0; number_box[1].data_type = INTEGER; number_box[1].min = 0; number_box[1].max = 30001;
        //snprintf(number_box[1].set_buf,number_box[1].box_width,"%d",global.zhuodu_data.seg_range_1);
        switch(global.zhuodu_data.range_sel)
        {
            case 0:
                snprintf(number_box[1].set_buf,number_box[1].box_width,"%-",global.zhuodu_data.seg_range_1);
                break;
            case 1:
                snprintf(number_box[1].set_buf,number_box[1].box_width,"%-d",global.zhuodu_data.seg_range_2);
                break;
            case 2:
                snprintf(number_box[1].set_buf,number_box[1].box_width,"%-d",global.zhuodu_data.seg_range_3);
                break;
            case 3:
                snprintf(number_box[1].set_buf,number_box[1].box_width,"%-d",global.zhuodu_data.seg_range_4);
                break;
            default:
                break;
        }
        LCD_DisplayString(13*8,0,"         ",NOT_REVERSE);
        LCD_DisplayString(13*8,16,"         ",NOT_REVERSE);
        LCD_DisplayString(13*8,32,"         ",NOT_REVERSE);
        LCD_DisplayString(13*8,48,"         ",NOT_REVERSE);
    }
